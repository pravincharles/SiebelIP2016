if (typeof (SiebelAppFacade.errorframework_postload_4) == "undefined") {
    Namespace('SiebelAppFacade.errorframework_postload_4');
  ...
  if (queryerror == false)
  {
	...
	if(window.fieldName){
	  ...
	  if(errorimg==="")
        {errorimg = "<div id=\"page-error_img\">" + "<img id=\"error_img\" src=\"images/loy_pf_stop.png\" alt=\"Error!\" style=\"width:20px;height:20px\">" + "</div>"};
