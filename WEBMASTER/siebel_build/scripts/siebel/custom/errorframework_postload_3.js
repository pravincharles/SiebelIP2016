if (typeof (SiebelAppFacade.errorframework_postload_3) == "undefined") {
    Namespace('SiebelAppFacade.errorframework_postload_3');
  ...
  if (queryerror == false)
  {
	...
	if(window.fieldName){
		 ...
		 if (Label === "Showval")
			{
					...
					if(msgArray[i].search("Field format error") != -1 ){
							$(':focus').addClass("req-input");
						}
	  ...
	  if(errorimg==="")
        {errorimg = "<div id=\"page-error_img\">" + "<img id=\"error_img\" src=\"images/Error image_New.gif\" alt=\"Error!\" style=\"width:20px;height:20px\">" + "</div>"};
