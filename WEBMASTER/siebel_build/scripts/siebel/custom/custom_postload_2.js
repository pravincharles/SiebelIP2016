if (typeof (SiebelAppFacade.custom_postload_2) == "undefined") {
    Namespace('SiebelAppFacade.custom_postload_2');
    ...
    (function(){
		...
		else if(CurrentView === "Account List View")
		{
			...
			$("div#_sweview>div").prepend($(AccordCode));
			//$("#CustomAccord1 p").append($("div a[title='Accounts']").parent());
			//$("#CustomAccord1 p").append($("div a[title='Account Detail']").parent());
