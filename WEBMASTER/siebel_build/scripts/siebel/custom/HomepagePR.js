if (typeof(SiebelAppFacade.HomepagePR) === "undefined") {

 SiebelJS.Namespace("SiebelAppFacade.HomepagePR");
 define("siebel/custom/HomepagePR", ["siebel/viewpr"],
  function () {
   SiebelAppFacade.HomepagePR = (function () {

    function HomepagePR(pm) {
     SiebelAppFacade.HomepagePR.superclass.constructor.apply(this, arguments);
    }

    SiebelJS.Extend(HomepagePR, SiebelAppFacade.ViewPR);

    HomepagePR.prototype.Init = function () {
     $( '#_swescrnbar' ).css("display", "none");
	 $( '#_swecontent' ).css("display", "none");
	 var mainDiv = '<div id="Title"><p>Views/Screens</p><div id="rectangle1"><p>Home</p></div><div id="rectangle2"><p>Opportunities</p></div><div id="rectangle3"><p>Accounts</p></div><div id="rectangle4"><p>Quotes</p></div><div id="rectangle5"><p>Sales Orders</p></div><div id="rectangle6"><p>Service</p></div><div id="rectangle7"><p>Contacts</p></div><div id="rectangle8"><p>Fleet Management</p></div><div id="rectangle9"><p>Calendar</p></div><div id="rectangle10"><p>Administration-Product</p></div><div id="rectangle11"><p>Administration-Fleet Management</p></div><div id="rectangle12"><p>User Preferences</p></div><div id = "arrow"></div></div>';
...
$("#rectangle8").click(function(){SiebelApp.S_App.GotoView("FM Sales Orders Screen Homepage View");$( '#_swescrnbar' ).css("display", "block");$( '#_swecontent' ).css("display", "block");$("#Title").remove();});
...
$("#rectangle11").click(function(){SiebelApp.S_App.GotoView("FM Location Administration View");$( '#_swescrnbar' ).css("display", "block");$( '#_swecontent' ).css("display", "block");$("#Title").remove();});
...
$("#ui-id-43").click(function(){$( '#_swescrnbar' ).css("display", "block");$( '#_swecontent' ).css("display", "block");$("#Title").remove();});
	...
	$("#Title").remove();
     ...
     SiebelAppFacade.HomepagePR.superclass.Init.apply(this, arguments);
     // Add code here that should happen after default processing
    }
    return HomepagePR;
   }()
  );
  return "SiebelAppFacade.HomepagePR";
 })
}