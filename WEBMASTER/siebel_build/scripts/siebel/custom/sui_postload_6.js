if (typeof (SiebelAppFacade.sui_postload_6) == "undefined") {
    Namespace('SiebelAppFacade.sui_postload_6');
    ...
    (function(){
        ...
        function OnPostload( ){
			...
			if($("div.tier1Back div#s_sctrl_tabScreen ul.ui-tabs-nav li[aria-expanded='true']").length && $("div.tier1Back div#s_sctrl_tabScreen ul.ui-tabs-nav li[aria-expanded='true']").text() != "Home")
			{
				...
				$("div.tier1Back div#s_sctrl_tabScreen ul.ui-tabs-nav li[aria-expanded='false']").remove();
