if (typeof (SiebelAppFacade.sui_postload_1) == "undefined") {
    Namespace('SiebelAppFacade.sui_postload_1');
    ...
    (function(){
        ...
        function OnPostload( ){
			...
			if($("div.tier1Back div#s_sctrl_tabScreen ul li [aria-controls='s_sctrl_tabScreen_noop'][aria-expanded='true']:not(:first-child)").length)
			{
