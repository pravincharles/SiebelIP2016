if (typeof (SiebelAppFacade.custom_postload_8) == "undefined") {
    Namespace('SiebelAppFacade.custom_postload_8');
    ...
    (function(){
		...
		if(CurrentObj === "Contact")
		{
			...
			RightHandNav();
		if(CurrentView === "Contact Details View (Detail tab)")
		{
			...
			$("#CustomAccord1 p").append($("div a[title='Contact Detail']").parent());
			$("#CustomAccord2 p").append($("div a[title='Contact']").parent());
			$("#accordionStyle").accordion({collapsible: true,active: false,heightStyle:"content"});
