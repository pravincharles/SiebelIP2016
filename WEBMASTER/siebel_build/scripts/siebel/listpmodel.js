    ...
    define("siebel/listpmodel", ["siebel/pmodel"], function () {
        SiebelAppFacade.ListPresentationModel = (function () {
            ...
            ListPresentationModel.prototype.Init = function () {
                ...
                this.AddMethod("HandleControlFocus", HandleControlFocus, { sequence: false, scope: this });
                this.AddMethod("SetFocustoFirstCell", function () { });
            ...
            function HandleControlFocus(defaultfocus) {
                this.ExecuteMethod("ExecuteHandleControlFocus", defaultfocus);
                if (!defaultfocus || (defaultfocus && !this.ExecuteMethod("GetListCol", defaultfocus.GetName()))) {
